...
$("#show_much").hide(); 
    ...
    <div class="user_box">
      <div class="avatar">
        ...
        <div class="name">您好<b><?php echo $_SESSION['username']?></b></div>
        <div class="link_bar">
          <a href="javascript:;" class="lock" onclick="fresh();" title="刷新">刷新</a> 
          <a href="javascript:;" class="lock" onclick="del_cache();" title="清除缓存">清除缓存</a> 
            <a href="index.php?r=admin/index" target="_blank" class="sitehome">网站首页</a>
            <a href="index.php?r=admin/login" class="exit">安全退出</a>        
        </div>
   </div>
</div>
