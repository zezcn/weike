...
<div class="page_title">
        ...
        <div class="tool">
            ...
            <a href="index.php?do=user&view=add" class="here">添加用户</a>
...
<tbody>
                      <tr>
                        ...
                        <td>
                       <input type="text" class="txt" style=" width:260px;"  value="" name="fds[username]" id="txt_username" maxlength="50" title="请输入2-20的字符或者汉字的用户名" limit="required:true;len:2-20" msg="请输入2-20的字符或者汉字的用户名" ajax="./index.php?do=register&check_username=" msgArea="txt_username_msg" valid="1"/><b style="color:red"> *</b><span id="txt_username_msg"></span>
