...
<h1>用户管理</h1>
     <div class="tool"> 
        ...
        <a href="index.php?r=user/add_user">添加用户</a>
 ...
 <tbody> 
    ...
    ?>
        ...
        <tr class="item">
            ...
            <td class="wraphide"><?php echo $value['groupname']?></td>
<td class="wraphide">普通</td>
<td><?php echo date('Y-m-d',$value['reg_time'])?></td>
...
<td>
<a class="button dbl_target" href="index.php?r=user/upd&uid=<?php echo $value['uid']?>"><span class="pen icon"></span>编辑</a>
...
<a class="button" href="index.php?do=user&view=custom_add&op=add&edituid=11&page=1"><span class="cog icon"></span>权限设置</a>
 							...
 							<a class="button" href="index.php?r=user/del&uid=<?php echo $value['uid']?>" onclick="return cdel(this);"><span class="trash icon"></span>删除</a>
</td>
 			        </tr>
                    <?php }?>
...
<button type="button" name="sbt_add"    value="添加新用户" class="positive primary pill button" onclick="document.location.href='index.php?r=user/add_user'"><span class="check icon"></span>添加新用户</button>
