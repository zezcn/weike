...
<input type="hidden" name="username" value="register_frm1"><!--账号-->
                        			<div class="rowElem clearfix po_re">
                            			<label class="grid_4">
                                			账　　 号：                            			</label>
                            			<div class="fl_l ">
                                			<input type="text" class="txt txt_input" autocomplete="off" name="data[username]" id="txt_account" limit="required:true;len:2-20;type:string;general:true" msg="用户名输入有误！" ajax="index.php?do=register&check_username=" title="2-20个字符或者汉字，推荐使用中文会员名。" msgArea="login_account_msg" style="width:200px;" />
                        		...
                        		<!--end 账号--><!--密码-->
                        			<div class="rowElem clearfix po_re">
                            			<label class="grid_4">
                                			密　 　码：                            			</label>
                            			<div class="fl_l  ">
                                			<input class="txt_input" onKeyup="pwStrength(this.value)" style="width:200px;" type="password" name="data[password]" id="pwd_password" maxlength="20" limit="required:true;len:6-20" msg="密码输入有误！" title="6-20个字符，请使用字母加数字或符号的组合密码" msgArea="password_msg"/>
...
<!--邮箱-->
                        			<div class="rowElem clearfix po_re">
                            			<label class="grid_4">
                                			邮　 　箱：                            			</label>
                            			<div class="fl_l">
                                			<input class="txt_input" style="width:200px;" autocomplete="off" type="text" class="txt" name="data[email]" id="txt_email"limit="type:email;required:true;len:6-50" msg="请输入您真实的邮箱地址！" title="请输入您常用的邮箱" ajax="index.php?do=register&check_email=" msgArea="email_msg"/>
