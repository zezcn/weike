<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_app_service_list', '1418787063' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="page_title">
    ...
    <div class="tool">
        <a href="index.php?do=<?php echo $do;?>&&view=<?php echo $view;?>" class="here">免费商品</a>
    </div>
</div>
<div class="box search p_relative">
    ...
    <div class="detail">
     ...
     <th>标题</th>
             ...
             <th>描述</th>
              <td>
                <input type="text" size='10' class="txt" name="space[desc]" value="<?php echo $space['desc'];?>" onkeyup="clearspecial(this);">
              </td>
            </tr>
             <tr>
                 <th>结果排序</th>
                  <td>
             		<select name="ord[]">
                           <option value="service_id" <?php if($ord['0']=='service_id' or !isset($ord['0'])) { ?> selected="selected"<?php } ?>><?php echo $_lang['default'];?><?php echo $_lang['order'];?></option>
...
<th>时间</th>
 ...
 <?php if(is_array($task_list)) { foreach($task_list as $key => $value) { ?>
               	<tr class="item">
               		<td><input type="checkbox" name="ckb[]" class="checkbox" value="<?php echo $value['service_id'];?>"><?php echo $value['service_id'];?></td>
<td><?php echo $value['username'];?></td>
<td><?php echo $value['service_title'];?></td>
<td><?php echo kekezu::cutstr($value['service_desc'], 30) ?></td>
               		<td>
               			<?php if($value['on_time']){echo date('Y-m-d H:i:s',$value['on_time']); } ?>&nbsp;
</td>
<td>
<a class="button dbl_target" href="index.php?do=<?php echo $do;?>&view=service_edit&op=edit&pro_id=<?php echo $value['service_id']?>"><span class="pen icon"></span><?php echo $_lang['edit'];?></a>
<a class="button" href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&op=del&pro_id=<?php echo $value['service_id']?>" onclick="return cdel(this);"><span class="trash icon"></span><?php echo $_lang['delete'];?></a>
</td> 
</tr>
<?php } } ?>	
<tr>
