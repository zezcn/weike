<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_app_task_list', '1418787077' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="page_title">
    ...
    <div class="tool">
        <a href="index.php?do=<?php echo $do;?>&&view=<?php echo $view;?>" class="here">免费任务</a>
    </div>
</div>
...
<th>时间</th>
 ...
 <?php if(is_array($task_list)) { foreach($task_list as $key => $value) { ?>
               	<tr class="item">
               		<td><input type="checkbox" name="ckb[]" class="checkbox" value="<?php echo $value['task_id'];?>"><?php echo $value['task_id'];?></td>
<td><?php echo $value['username'];?></td>
<td><?php echo kekezu::cutstr($value['task_title'],30) ?></td>
<td><?php echo kekezu::cutstr($value['task_desc'], 30) ?></td>
               		<td>
               			<?php if($value['on_time']){echo date('Y-m-d H:i:s',$value['on_time']); } ?>&nbsp;
</td>
<td>
<a class="button dbl_target" href="index.php?do=<?php echo $do;?>&view=task_edit&op=edit&pro_id=<?php echo $value['task_id']?>"><span class="pen icon"></span><?php echo $_lang['edit'];?></a>
<a class="button" href="index.php?do=<?php echo $do;?>&view=<?php echo $view;?>&op=del&pro_id=<?php echo $value['task_id']?>" onclick="return cdel(this);"><span class="trash icon"></span><?php echo $_lang['delete'];?></a>
</td> 
</tr>
<?php } } ?>	
<tr>
