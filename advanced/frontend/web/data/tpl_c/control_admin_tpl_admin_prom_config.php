<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_prom_config', '1418787083' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<?php if($m) { ?><option id="s_indus_select_op_<?php echo $m;?>" value="<?php echo $m?>" selected="selected"><?php echo $indus_arr[$m]['indus_name']?></option><?php } ?>
  <?php } } ?>
</select>
<br class="clear">
...
<input type="text" size="5" class="txt" name="pub_task_credit" id="pub_task_credit" value="<?php echo $prom_config['credit'];?>" /><?php echo $_lang['cash_coupon'];?>
    </div>
