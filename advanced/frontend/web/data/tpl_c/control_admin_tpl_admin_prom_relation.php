<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_prom_relation', '1418787083' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<td>
                    <a  href="index.php?do=prom&view=relation_add&ac=edit&relation_id=<?php echo $v['relation_id']?>" class="button dbl_target"><span class="pen icon"></span><?php echo $_lang['update'];?></a>
