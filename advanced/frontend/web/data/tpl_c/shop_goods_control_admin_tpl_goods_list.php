<?php keke_tpl_class::checkrefresh('shop/goods/control/admin/tpl/goods_list', '1418787051' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<a href="<?php echo $url_str;?>&ac=pass&service_id=<?php echo $v['service_id'];?>&page=<?php echo $page;?>" onclick="return  cdel(this,'<?php echo $_lang['shelves_this_product'];?><?php echo $_lang['zh_wh'];?>');" class="button"><span class="check icon"></span><?php echo $_lang['shelves'];?></a>
<?php } ?>
<?php if($v['service_status']==2) { ?>
<a href="<?php echo $url_str;?>&ac=nopass&service_id=<?php echo $v['service_id'];?>&page=<?php echo $page;?>" onclick="return cdel(this,'<?php echo $_lang['merchandise_off_the_shelf'];?><?php echo $_lang['zh_wh'];?>');" class="button"><span class="lock icon"></span><?php echo $_lang['off_the_shelf'];?></a>
<?php } ?>
</td>
            </tr>
            <?php } } ?>
...
<button class="pill negative" type="submit" value="<?php echo $_lang['mulit_delete'];?>" onclick="return batch_act(this,'frm_list');"><span class="icon trash">&nbsp;</span><?php echo $_lang['mulit_delete'];?></button>                        
                        <button class="pill negative" type="submit" value="<?php echo $_lang['batch_shelves']?>" onclick="return batch_act(this,'frm_list');" ><span class="icon check">&nbsp;</span><?php echo $_lang['batch_shelves']?></button>
<button class="pill negative" type="submit" value="<?php echo $_lang['batch_off_the_shelf']?>" onclick="return batch_act(this,'frm_list');"><span class="icon lock">&nbsp;</span><?php echo $_lang['batch_off_the_shelf']?></button>
</div>
                 </td>
        	</tr>
 </tbody>
