<?php keke_tpl_class::checkrefresh('shop/goods/control/admin/tpl/goods_order', '1418787050' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
onclick="checkall();" /> <label for="checkbox"><?php echo $_lang['select_all'];?></label>
<input type="hidden" name="sbt_action"
value="<?php echo $_lang['mulit_delete'];?>" />
<button class="pill negative" type="submit"
value="<?php echo $_lang['mulit_delete'];?>" name="sbt_action"
