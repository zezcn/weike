<?php keke_tpl_class::checkrefresh('tpl/default/prom/prom_good', '1418795106' );?><?php if($_K['inajax']) { ?>
            		...
            		<div class="pad20">
            			...
            			<div class="grid_15">
            				<div>	
            					...
            					<span class="cf60"><?php echo $effect_mode_service['rate'];?>%</span>提成
            				</div>
            				<div class="font14b cf60">你的收益＝商品售价×<?php echo $effect_mode_service['rate'];?>%
            				</div>
            				<div>
            					指用户通过推广链接\代码购买商品，商品交易成功结束即为推广有效，推广员能获得任务金额<span class="cf60"><?php echo $effect_mode_service['rate'];?>%</span>的提成。
            				</div>
...
<td><a title="<?php echo $v['title'];?>" target="_blank" href="index.php?do=service&sid=<?php echo $v['service_id'];?>"><?php echo kekezu::cutstr($v['title'],68) ?></a></td>
<td class="t_c"><?php  echo keke_curren_class::output(floatval($v['price']),-1);  ?></td><?php $v['price'] = keke_curren_class::convert($v['price']); ?>
<td class="t_c"><?php echo $v['price'];?>&times;<?php echo $v['profit_rate'];?>%&times;<?php echo $prom_rule['rate'];?>%=<font color="red"><?php echo $v['price']*$v['profit_rate']*$prom_rule['rate']/10000; ?></font></td>
<td><button onclick="promLink('service','service','<?php echo $v['service_id'];?>','<?php echo $v['title'];?>');" href="javascript:void(0);">获取推广链接</button></td>
</tr>
<?php } } ?>
         ...
         <tr>
          	<td colspan="5"><div class="page clearfix"><p><?php echo $pages['page'];?></p><span class="t_r"><?php echo $_lang['load_result'];?><?php echo $count;?><?php echo $_lang['tiao'];?></span></div></td>
  </tr>
